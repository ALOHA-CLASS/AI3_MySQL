...
SELECT 
    DATE_SUB( STR_TO_DATE('2025-09-17', '%Y-%m-%d'), INTERVAL 10 DAY ) AS '종강일10일전'
   ,DATE_SUB( STR_TO_DATE('2025-09-17', '%Y-%m-%d'), INTERVAL 2 MONTH ) AS '종강일2달전'
   ,DATE_SUB( STR_TO_DATE('2025-09-17', '%Y-%m-%d'), INTERVAL 1 YEAR ) AS '종강일1년전'
FROM dual;
